...
const LEVELS = [
  {
    id: 1,
    name: "Level 1",
    description: "Getting started with basic words",
    image: "/images/level1.png",
  },
  {
    id: 2,
    name: "Level 2",
    description: "Building confidence with common words",
    image: "/images/level2.png",
  },
  {
    id: 3,
    name: "Level 3",
    description: "Mastering more complex sights",
        ...
        <div className="mx-auto grid max-w-3xl grid-cols-1 gap-6 md:grid-cols-3">
          {LEVELS.map((level) => (
            <button
              ...
              className={`group relative flex flex-col items-center gap-4 rounded-[2rem] border border-zinc-100 bg-white p-6 shadow-lg transition-all duration-300 ${
